...
// Productos, Departamentos, Categorías y Colecciones son un mismo árbol de
// catálogo — viven en rutas separadas (cada una con su propia query y
// formulario) pero se presentan como pestañas de una sola sección para que
// el equipo no las viva como 4 pantallas desconectadas.
export function CatalogoTabs({
  active,
  role,
}: {
  active: "productos" | "departamentos" | "categorias" | "colecciones";
  role: Profile["role"];
}) {
