              ...
              <div className="bg-[#0f0f0f] border border-white/10 rounded-2xl p-6 md:p-8 relative overflow-hidden animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                {authMode === 'login' && (
                  <form onSubmit={handleStep1Submit} className="space-y-5">
                    ...
                    <button type="button" className="w-full bg-white text-black font-bold p-3.5 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-100 transition-colors cursor-pointer text-xs uppercase tracking-widest">
