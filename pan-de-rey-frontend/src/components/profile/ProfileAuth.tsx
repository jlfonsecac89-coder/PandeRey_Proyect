            ...
            {authMode === 'login' && (
              <form onSubmit={handleSubmit} className="space-y-5 animate-in fade-in duration-300">
                ...
                <button 
                  ...
                  className="w-full bg-white text-black font-bold p-3 rounded-md flex items-center justify-center gap-3 hover:bg-gray-100 transition-colors cursor-pointer"
                >
      ...
      <GoogleAuthModal
        ...
        onSuccess={(user) => {
          localStorage.setItem('pan_de_rey_active_customer', JSON.stringify({
            ...
            rut: '19.827.364-K',
            points: 500, // Seed 500 welcome points!
            isGoogle: true
          }));
          onLogin();
        }}
